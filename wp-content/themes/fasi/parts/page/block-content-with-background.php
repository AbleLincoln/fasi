...
$main_block_class = 'block-content-with-background';
...
<section <?php echo $anchor; ?>class="<?php echo $main_block_class; ?>">
    <?php if ( ! empty( $image ) ) : ?>
        <div class="block-content-with-background__image">
            <?php echo wp_get_attachment_image( $image, 'content-background' ); ?>
    ...
    <div class="container">
        <div class="row">
            <?php if ( ! empty( $subhead ) || ! empty( $content ) ) : ?>
                <div class="block-content-with-background__content col-12 col-lg-9">
